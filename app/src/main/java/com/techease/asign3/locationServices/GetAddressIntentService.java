package com.techease.asign3.locationServices;
...
import com.techease.asign3.ui.CurrentLocationFragment;
...
public class GetAddressIntentService extends IntentService {
    ...
    protected void onHandleIntent(@Nullable Intent intent) {
        ...
        CurrentLocationFragment.strLatLog = location.getLatitude()+","+location.getLongitude();
